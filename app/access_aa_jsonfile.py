...
jsonfile_name = "./aa_jsonfile.json"
members_jsonfile = "./aa_members.json"


def write_aa_members_jsonfile(member_model_list):
...
def write_aa_repair_info_jsonfile(repair_info_model_list):
...
def put_aa_members_jsonfile(index, new_password):
    with open(members_jsonfile, 'r') as jsonfile_list:
...
def put_aa_status_jsonfile(index, string):
...
def put_aa_end_time_jsonfile(index, time_str):
    with open(jsonfile_name, 'r+') as jsonfile:
        dict_list = json.load(jsonfile)
